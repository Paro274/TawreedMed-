    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card shadow-sm">
                {{-- ✅ تغيير العنوان واللون لتمييز العميل --}}
                <div class="card-header bg-primary text-white">{{ __('تعيين كلمة مرور جديدة') }}</div>

                <div class="card-body">
                    {{-- ✅ التعديل الأهم: الرابط الخاص بالعميل --}}
                    <form method="POST" action="{{ route('frontend.customer.password.update') }}">
                        @csrf
                        ...
                        <div class="form-group mb-3">
                            ...
                            {{-- ✅ readonly عشان العميل ما يغيرش الإيميل بالغلط --}}
