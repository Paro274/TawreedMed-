...
@section('title', 'قائمة الطلب السريع - توريد ميد')

@section('content')
<div class="container py-5">
    <div class="text-center mb-4">
        <h1 class="h2 fw-bold text-primary mb-3">قائمة الطلب السريع للأدوية</h1>
                ...
                <table class="table table-hover align-middle mb-0 text-end" dir="rtl">
                    <thead class="bg-light">
                        <tr>
                            ...
                            <th scope="col" class="text-center" width="100">سعر الجمهور</th>
                            <th scope="col" class="text-center" width="100">نسبة الخصم</th>
                            <th scope="col" class="text-center" width="100">السعر بعد الخصم</th>
                    ...
                    <tbody>
                        @forelse($products as $index => $product)
                            ...
                            <tr id="row-{{ $product->id }}">
                                ...
                                <td class="text-center">
                                    <span class="fw-bold fs-6">{{ number_format($finalPrice, 2) }}</span>
                                </td>
                                <td class="text-center">
                                    @if($isAvailable)
                                        <input type="number" 
    ...
    <div class="container">
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-center gap-3">
            ...
            <div class="d-flex gap-3">
                 <!-- Previous Button -->
                <a href="{{ route('frontend.medicines.index') }}" class="btn btn-outline-primary btn-lg px-4 rounded-3 d-flex align-items-center justify-content-center bg-white text-primary border-primary hover-effect" style="width: 140px;">
...
function updateRowTotal(input) {
    ...
    if (qty > 0 && qty < min) {
        // We allow the user to type, but we can highlight it
        // Or we can let the final submission handle the alert for all items
        // For now, let's just make sure the total calculation is correct
    }
