...
@section('title', 'مستحضرات التجميل - توريد ميد')
...
<section class="page-header">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-8">
                <h1 class="page-title">مستحضرات التجميل</h1>
                <p class="page-subtitle">منتجات تجميل عالية الجودة من أفضل العلامات التجارية</p>
            </div>
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">مستحضرات التجميل</li>
            </ol>
        </nav>
    </div>
</section>
...
<section class="category-links">
    <div class="container">
        <div class="category-tabs">
            ...
            <a href="{{ route('frontend.cosmetics.index') }}" class="category-tab active">
                <span class="tab-icon">💄</span>
...
<section class="quick-order-cta py-4 bg-white">
    <div class="container text-center">
        <a href="{{ route('frontend.cosmetics.quick-order') }}" class="btn btn-lg btn-success pulse-animation shadow-lg px-5 py-3 rounded-pill" style="min-width: 300px;">
...
<section class="featured-products">
    <div class="container">
        ...
        <div class="products-grid featured-grid">
            ...
            <div class="product-card small" onclick="window.location.href='{{ route('frontend.cosmetics.show', $product->slug ?? $product->id) }}'" style="cursor: pointer;">
                <div class="product-image">
                    <a href="{{ route('frontend.cosmetics.show', $product->slug) }}" onclick="event.stopPropagation()">
                        @if($product->image_1)
                            <img src="{{ $product->getImageUrl(1) }}" 
                                 alt="{{ $product->name }}"
                                 style="object-fit: contain; padding: 5px;">
                        @else
                            <div class="no-image"><i class="fas fa-magic fa-2x"></i></div>
                        @endif
                    </a>
                </div>
        ...
        <div class="products-layout">
            ...
            <aside class="filters-sidebar">
                <div class="filter-header">
                    <h3>الفلاتر</h3>
                    <a href="{{ route('frontend.cosmetics.index') }}" class="clear-filters">مسح الكل</a>
                </div>

                <form method="GET" action="{{ route('frontend.cosmetics.index') }}" id="filterForm">
                    <!-- Search Filter -->
                    <div class="filter-group">
                        ...
                        <input type="text" 
                               name="search" 
                               class="search-input" 
                               placeholder="ابحث عن منتج تجميل..."
            ...
            <div class="products-content">
                ...
                <div class="products-toolbar">
                    ...
                    <div class="toolbar-actions">
                        <form method="GET" action="{{ route('frontend.cosmetics.index') }}" class="sort-form">
                ...
                <div class="active-filters">
                    @if(request('search'))
                        <span class="filter-tag">
                            ...
                            <a href="{{ route('frontend.cosmetics.index', request()->except('search')) }}">&times;</a>
                        </span>
                    @endif
                    <a href="{{ route('frontend.cosmetics.index') }}" class="clear-all-filters">مسح الكل</a>
                </div>
                @endif
                ...
                <div class="products-grid">
                        ...
                        <div class="product-card" onclick="window.location.href='{{ route('frontend.cosmetics.show', $product->slug ?? $product->id) }}'">
                            ...
                            <div class="product-info">
                                ...
                                <div class="product-price">
                                    ...
                                    <span class="unit">جنيه / {{ $product->package_type ?? 'عبوة' }}</span>
                                </div>
                    ...
                    @empty
                        <div class="no-products">
                            ...
                            <h3>لا توجد منتجات تجميل</h3>
                            <p>لم يتم العثور على منتجات تطابق معايير البحث</p>
                            <a href="{{ route('frontend.cosmetics.index') }}" class="btn btn-primary">عرض جميع المنتجات</a>
                        </div>
                    @endforelse
                </div>
