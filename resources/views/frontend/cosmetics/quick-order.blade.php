...
@section('title', 'قائمة الطلب السريع لمستحضرات التجميل - توريد ميد')

@section('content')
<div class="container py-5">
    <div class="text-center mb-4">
        <h1 class="h2 fw-bold text-primary mb-3">قائمة الطلب السريع لمستحضرات التجميل</h1>
    ...
    <div class="container">
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-center gap-3">
            ...
            <div class="d-flex gap-3">
                 <!-- Previous Button -->
                <a href="{{ route('frontend.cosmetics.index') }}" class="btn btn-outline-primary btn-lg px-4 rounded-3 d-flex align-items-center justify-content-center bg-white text-primary border-primary hover-effect" style="width: 140px;">
