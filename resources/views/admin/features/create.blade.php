            ...
            <div class="preview-section" id="previewSection" style="display: none;">
                ...
                <div class="preview-content">
                    ...
                    <div class="preview-text">
                        <div class="preview-title" id="fullPreviewTitle">عنوان الميزة</div>
                        <div class="preview-desc" id="fullPreviewDesc">وصف مفصل للميزة سيظهر هنا...</div>
                    </div>
                </div>
            </div>

            <button type="submit" class="btn">إضافة الميزة الجديدة</button>
        </form>
...
function updatePreview() {
    const title = document.getElementById('title').value || 'عنوان الميزة';
    const description = document.getElementById('description').value || 'وصف مفصل للميزة سيظهر هنا...';
