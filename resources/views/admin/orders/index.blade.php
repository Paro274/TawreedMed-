...
<head>
    ...
    <style>
        body { font-family: "Cairo", sans-serif; background: #f4f5fb; margin: 0; padding: 0; }
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><span class="status-badge status-{{ $order->payment_status }}">{{ $order->payment_status_label }}</span></td>
